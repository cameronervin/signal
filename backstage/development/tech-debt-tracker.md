...
| 2026-07-05 | TD-004 | First Codex issue loop dry run still needs post-workflow confirmation | Branch creation, commit, PR creation, and final label transitions happen after Codex exits | Review issue `#2`, the generated PR, and the `Codex issue loop` run before enabling broader automation |
