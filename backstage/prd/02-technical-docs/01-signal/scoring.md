...
The Neo4j-backed knowledge graph can add explainable sales insights in the
stable `talking_points` field and related lead context, but this implementation
does not change score weights, tier thresholds, or the planned related-graph
bonus.
