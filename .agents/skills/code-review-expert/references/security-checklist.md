...
- Client-controlled score, tier, gate-pass, draft, or run-status fields
- New endpoints that assume future auth exists without documenting the production gap
...
Race conditions cause intermittent failures and security vulnerabilities.
