...
def create_lead_intelligence_graph(nodes: dict[str, object]) -> StateGraph:
    ...
    builder.add_edge(DETERMINISTIC_ENRICHMENT_NODE, KNOWLEDGE_GRAPH_INGEST_NODE)
    builder.add_edge(KNOWLEDGE_GRAPH_INGEST_NODE, GRAPH_CONTEXT_RETRIEVAL_NODE)
    builder.add_edge(GRAPH_CONTEXT_RETRIEVAL_NODE, DETERMINISTIC_SCORING_NODE)
